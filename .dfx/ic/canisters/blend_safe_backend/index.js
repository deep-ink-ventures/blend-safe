...
import { idlFactory } from './blend_safe_backend.did.js';
export { idlFactory } from './blend_safe_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BLEND_SAFE_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./blend_safe_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the blend_safe_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./blend_safe_backend.did.js")._SERVICE>}
 */
export const blend_safe_backend = createActor(canisterId);
